...
<div class="quiz-container">
  <div class="quiz-question">1. Qual a função básica de um Sistema Operacional (SO)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">2. Como é chamada a parte central e mais crítica de um Sistema Operacional, que fica sempre na memória RAM?</div>
...
<div class="quiz-container">
  <div class="quiz-question">3. O que é "Gerenciamento de Processos" em um SO?</div>
...
<div class="quiz-container">
  <div class="quiz-question">4. O que acontece se dois programas tentarem usar o mesmo espaço exato na memória RAM ao mesmo tempo?</div>
...
<div class="quiz-container">
  <div class="quiz-question">5. Qual o papel fundamental dos "Drivers" (Controladores de Dispositivos)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">6. A sigla GUI (Graphical User Interface) refere-se a:</div>
...
<div class="quiz-container">
  <div class="quiz-question">7. O que caracteriza uma interface CLI (Command Line Interface)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">8. Qual o nome da camada de software que recebe os comandos do usuário (via texto ou cliques) e os envia para o Kernel?</div>
...
<div class="quiz-container">
  <div class="quiz-question">9. FAT32, NTFS e EXT4 são exemplos de:</div>
...
<div class="quiz-container">
  <div class="quiz-question">10. Se um programa para de responder ("trava"), qual componente do SO é responsável por permitir que o usuário force o seu fechamento?</div>
