...
<div class="quiz-container">
  <div class="quiz-question">1. Qual símbolo visual representa a porta **NOT** nos diagramas lógicos?</div>
...
<div class="quiz-container">
  <div class="quiz-question">2. A porta lógica que possui o formato de um "D" alongado é a:</div>
...
<div class="quiz-container">
  <div class="quiz-question">3. Qual componente é responsável por realizar a soma de dois bits individuais e gerar um "vai-um"?</div>
...
<div class="quiz-container">
  <div class="quiz-question">4. Em um Half-Adder (Meio Somador), qual porta lógica é utilizada para calcular o bit da **SOMA**?</div>
...
<div class="quiz-container">
  <div class="quiz-question">5. Qual porta lógica do Half-Adder gera o bit de **CARRY** (Vai-um)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">6. Qual a principal diferença entre um Half-Adder e um Full-Adder (Somador Completo)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">7. Milhares de portas lógicas compactadas em uma única pastilha de silício formam um:</div>
...
<div class="quiz-container">
  <div class="quiz-question">8. Qual o nome do componente eletrônico básico que atua como um "interruptor" para os bits e forma as portas lógicas?</div>
...
<div class="quiz-container">
  <div class="quiz-question">9. O material químico mais utilizado na fabricação de chips por ser um semicondutor é o:</div>
...
<div class="quiz-container">
  <div class="quiz-question">10. Se ligarmos a saída de uma porta AND na entrada de uma porta NOT, que porta lógica combinada teremos?</div>
