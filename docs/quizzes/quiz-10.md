...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Ela é uma ferramenta exaustiva que prova o comportamento de uma expressão lógica.*">Armazenar senhas de usuários</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="O número de linhas é dado por $2^n$, onde $n$ é o número de variáveis ($2^3 = 8$).*">9</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="$2^4 = 16$. A cada nova variável, o número de linhas dobra.*">32</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="O XOR resulta em 1 para (1,0) ou (0,1), e 0 para (0,0) ou (1,1).*">Saída 1 o tempo todo</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Como as entradas são iguais, o OU Exclusivo exclui essa possibilidade, resultando em Falso (0).*">2</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="NAND = NOT AND. Ele inverte o resultado de uma porta E.*">NOT</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="O NOR (Non-OR) é o oposto do OU; ele só aprova quando tudo é falso.*">É idêntico ao OR</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Uma tautologia indica que a expressão é sempre verdadeira por definição lógica.*">Bug</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Isso permite que fábricas de chips produzam apenas um tipo de portão lógico para criar CPUs inteiras.*">Porque suportam voltagens mais altas</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Incorreto. Tente novamente.">XOR</div>
  <div class="quiz-option" data-correct="false" data-feedback="A negação de um OU é exatamente a função NOR.*">AND</div>
  <div class="quiz-feedback"></div>
</div>
