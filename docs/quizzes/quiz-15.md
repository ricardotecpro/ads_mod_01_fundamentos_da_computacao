...
<div class="quiz-container">
  <div class="quiz-question">1. Qual a definição mais precisa de um "Algoritmo"?</div>
...
<div class="quiz-container">
  <div class="quiz-question">2. Por que dizemos que um algoritmo deve ser "finito"?</div>
...
<div class="quiz-container">
  <div class="quiz-question">3. No padrão visual de fluxogramas, qual símbolo representa o **Início** ou o **Fim** do processo?</div>
...
<div class="quiz-container">
  <div class="quiz-question">4. Qual símbolo é utilizado para indicar uma **Ação** ou **Processo** (como um cálculo ou movimento de dados)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">5. O símbolo em formato de **Losango** é fundamental para representar:</div>
...
<div class="quiz-container">
  <div class="quiz-question">6. A estrutura lógica "SE (condição) ENTÃO (ação) SENÃO (outra ação)" é conhecida como:</div>
...
<div class="quiz-container">
  <div class="quiz-question">7. No fluxograma, a direção do fluxo de execução é indicada por:</div>
...
<div class="quiz-container">
  <div class="quiz-question">8. O que é "Pseudocódigo" (ou Portugol)?</div>
...
<div class="quiz-container">
  <div class="quiz-question">9. Qual a principal vantagem de desenhar um fluxograma antes de começar a codificar um programa?</div>
...
<div class="quiz-container">
  <div class="quiz-question">10. Se em um fluxograma de decisão a pergunta for "O saldo é maior que 100?" e o valor real for 50, o fluxo deve seguir pelo caminho:</div>
