...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Como $2^4 = 16$, cada grupo de 4 bits (Nibble) corresponde a um único dígito hexadecimal.*">Multiplicar cada bit por 16</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Um nibble é a metade de um byte e a unidade básica do hexadecimal.*">Octeto</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="true" data-feedback="$1101$ em binário é $8+4+1 = 13$, que em hexadecimal é a letra D.*">D</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="$1010 = 10 (A)$ e $1111 = 15 (F)$. Portanto, AF.*">BF</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Sempre começamos pelo bit de menor peso (direita) para garantir o alinhamento correto das potências.*">Tanto faz</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="Adicionar zeros à esquerda não altera o valor do número, mas ajuda na conversão correta.*">Deixar como está</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="O zero à esquerda é fundamental para manter a estrutura de 4 bits do nibble.*">0007</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="E é 14, que em binário é $8 + 4 + 2 + 0$, ou seja, 1110.*">1111</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="$16 \text{ bits} / 4 \text{ bits por dígito} = 4$ dígitos hexadecimais.*">16</div>
  <div class="quiz-feedback"></div>
</div>
...
<div class="quiz-container">
  ...
  <div class="quiz-option" data-correct="false" data-feedback="O IPv6 usa hexadecimal para tornar a leitura de seus 128 bits muito menos cansativa para os humanos.*">Números de telefone</div>
  <div class="quiz-feedback"></div>
</div>
