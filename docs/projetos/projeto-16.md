...
## 📋 Requisitos
1. **Ambiente**: Use um editor online (como o [Replit](https://replit.com/languages/python3)) ou instale o Python no seu computador.
2. **O Código**: Seu programa deve:
...
3. **Desafio Extra**: Tente adicionar uma condição (**IF**) que exiba uma mensagem especial caso a temperatura seja maior que 30 graus (ex: "Está um dia quente!").

## 🚚 Entrega
Crie um "Relatório de Programação" contendo:
- O código fonte que você escreveu (texto).
- Um print do programa funcionando (com um teste de exemplo).
