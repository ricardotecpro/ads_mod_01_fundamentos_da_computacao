# 💪 Exercícios — Aula 03: Conversão de Binário para Decimal
...
### 2. O Valor dos Pesos
Sem fazer a soma completa, responda:
- Quanto vale um bit '1' na posição de índice 3 (quarta casa da direita para a esquerda)?
- Quanto vale um bit '1' na posição de índice 0 (primeira casa à direita)?
